...
public class MusicPlayerRunner : MonoBehaviour
{
    [System.Serializable]
    public class Stem
    {
	...
	static protected MusicPlayerRunner s_Instance;
	static public MusicPlayerRunner instance { get { return s_Instance; } }
