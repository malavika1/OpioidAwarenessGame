...
public class GameOverState : AState
{
    ...
    public override void Enter(AState from)
    {
		...
		if (MusicPlayerRunner.instance.GetStem(0) != gameOverTheme)
		{
            MusicPlayerRunner.instance.SetStem(0, gameOverTheme);
			StartCoroutine(MusicPlayerRunner.instance.RestartAllStems());
        }
    }
